...
![Haswell Acpi CC Section 1](./assets/image%20%2861%29.png)

![Haswell Acpi CC Section 2](./assets/image%20%286%29.png)
...
![Haswell Boot CC Section](./assets/image%20%2862%29.png)
...
![Haswell Devices CC Section - iGPU](
assets/image%20%2846%29.png)

![Haswell Devices CC Section - iGPU \(Connectorless\) + dGPU](./assets/image%20%2827%29.png)

<p align="center">
![Device-Id fake for HD 4400 --&amp;gt; HD 4600](./assets/image%20%288%29.png)
</p>
### Explanation
...
![Haswell Gui CC Section](./assets/image%20%2867%29.png)
...
![Haswell KernelAndKextPatches CC Section](./assets/image%20%2849%29.png)
...
![Haswell Rt Variables CC Section](./assets/image%20%2826%29.png)

![Haswell SMBIOS CC Section](./assets/image%20%2839%29.png)
...
![System Parameters CC Section](./assets/image%20%2843%29.png)
...
At this point, you can do _File -&gt; Save_ to save the config.plist. If you have issues saving directly to the EFI, you can save it on the Desktop, then just copy it over. I'll leave the [sample config.plist](https://github.com/corpnewt/Hackintosh-Guide/blob/master/Configs/Haswell/config.plist) here
 too.
